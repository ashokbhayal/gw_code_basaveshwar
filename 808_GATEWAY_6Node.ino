...
#define API_KEY1 "08YLY5OJHJMBRYRU"  
#define API_KEY2 "8C9IUJEKG7EMZEZV"
#define API_KEY3 "TJLEDTD26UNO6O3Y"
#define API_KEY4 "F101S4IZ4H8T6R2D"
#define API_KEY5 "R6A9FZWU2WSKGY3H"
#define API_KEY6 "USOGS2X4OXAYMMYA"
...
const char cstt[] PROGMEM = "AT+CSTT=\"www\"";
...
void mac_api(unsigned long a, unsigned long b, unsigned long c )
{
  ...
  if ( a == 0x10 && b == 0x4B && c == 0xD8) // 10:a9:d3
  {
    API_KEY = API_KEY5;
    a = 0 ; b = 0; c = 0;
